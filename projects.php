                    ...
                    <?php if ($project['title']): ?>
                        <div class="flex w-full flex-col rounded-lg border bg-[#1e293b] lg:w-[48%]">
                            ...
                            <div class="aspect-video w-full rounded-md p-2 lg:p-3">
                                <img alt="<?php echo esc_attr($project['title']); ?>" loading="lazy" width="1920" height="1080"
                            ...
                            <div class="px-2 pb-2 lg:px-3">
                                <div class="flex items-center justify-between border-b">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <?php if ($project['live_demo']): ?>
                                            <a href="<?php echo esc_url($project['live_demo']); ?>" target="_blank"
                                        ...
                                        <?php if ($project['github']): ?>
                                            <a href="<?php echo esc_url($project['github']); ?>" target="_blank"><img alt="GitHub"
                                ...
                                <div class="mt-2 flex flex-col gap-2 self-start rounded-md">
                                    <span
                                        class="text-justify font-secondary text-base leading-6 text-secondary-foreground"><?php echo esc_html($project['description']); ?></span>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
